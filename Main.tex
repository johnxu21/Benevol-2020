...
We therefore performed an exploratory investigation on the evolution of variants, focusing on their technical aspects. We collected variants from the \js ecosystem, whose sources are hosted on \gh, and whose packages are  released on \npm. We have identified a a total 12,813 variant forks from the \js ecosystem. In general, we found that mainlines have more number of package releases, package dependencies, dependent packages and dependent projects compared to their variant counterparts. However, it is still interesting that some variants have more package releases and dependents packages/project compared to their mainline counterparts.  

%compared to the mainline counterparts, we found that variant forks to have a relatively fewer number of package releases, package dependencies, dependent packages and dependent projects.
