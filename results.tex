...
\begin{figure*}%
    \centering
    \subfloat[\centering Packages]{{\includegraphics[width=8cm]{figures/dependents} }}%
    \qquad
    \subfloat[\centering Projects]{{\includegraphics[width=8cm]{figures/benevolj_projects} }}%
...
\begin{figure*}%
    \centering
    \subfloat[\centering Mainlines]{{\includegraphics[width=8cm]{figures/benevolj_dependents_mainline.pdf} }}%
    \qquad
    \subfloat[\centering Variants]{{\includegraphics[width=8cm]{figures/benevolj_dependents_variant.pdf} }}%
